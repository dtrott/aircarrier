		...
		try {
			...
			if (audio != null) {
				...
				audioTrackerL = SoundUtils.createSFXTracker(
						CarrierSimpleLevelManagers.class.getResource("/resources/sound/generic_prop_low.ogg"),
						planes.get(0).getBase(), 120, 240, 0.1f);
				audioTrackerM = SoundUtils.createSFXTracker(
						CarrierSimpleLevelManagers.class.getResource("/resources/sound/generic_prop_mid.ogg"),
						planes.get(0).getBase(), 120, 240, 0.1f);
				audioTrackerWind = SoundUtils.createSFXTracker(
						CarrierSimpleLevelManagers.class.getResource("/resources/sound/wind.ogg"),
						planes.get(0).getBase(), 120, 240, 0.1f);

				if (gunSounds) {
					audioTrackG0 = SoundUtils.createSFXBasic(
							CarrierSimpleLevelManagers.class.getResource("/resources/sound/gun.ogg"));
					...
					audioTrackG1 = SoundUtils.createSFXBasic(
							CarrierSimpleLevelManagers.class.getResource("/resources/sound/gun_small.ogg"));
