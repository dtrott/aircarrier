...
public class SmokerFactory {
	...
	static AlphaState flameAlphaState;
	static AlphaState smokeAlphaState;
	...
	public static ParticleMesh makeSmoker() {
		...
		return makeParticleMesh(
				...
				smokeAlphaState, smokeTextureState, 
				rise, 
	...
	public static ParticleMesh makeFlamer() {
		...
		return makeParticleMesh(
				...
				flameAlphaState, flameTextureState, 
				burn, 
	...
	public static ParticleMesh makeParticleMesh(
	    ...
	    pMesh.setRenderState(alphaState);
	...
	static void makeStates() {
		if (flameAlphaState == null) {
			smokeAlphaState = DisplaySystem.getDisplaySystem().getRenderer().createAlphaState();
			smokeAlphaState.setBlendEnabled(true);
			//smokeAlphaState.setSrcFunction(AlphaState.SB_ZERO);
			//smokeAlphaState.setDstFunction(AlphaState.DB_ONE_MINUS_SRC_COLOR);
			smokeAlphaState.setSrcFunction(AlphaState.SB_SRC_ALPHA);
			smokeAlphaState.setDstFunction(AlphaState.DB_ONE_MINUS_SRC_ALPHA);			
			smokeAlphaState.setTestEnabled(true);
			smokeAlphaState.setEnabled(true);

			flameAlphaState = DisplaySystem.getDisplaySystem().getRenderer().createAlphaState();
			flameAlphaState.setBlendEnabled(true);
			flameAlphaState.setSrcFunction(AlphaState.SB_SRC_ALPHA);
			flameAlphaState.setDstFunction(AlphaState.DB_ONE);
			flameAlphaState.setTestEnabled(true);
			flameAlphaState.setEnabled(true);
